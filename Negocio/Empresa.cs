...
namespace Negocio
{
    public class Empresa : Base
    {
        ...
        private int _CodigoPaisDepartamento = 0; public int CodigoPaisDepartamento { get => _CodigoPaisDepartamento; set => _CodigoPaisDepartamento = value; }
        ...
        private int _TipoCliente = 0; public int TipoCliente { get => _TipoCliente; set => _TipoCliente = value; }
        ...
        private bool Validar()
        {
            ...
            try
            {
                ...
                if (_CodigoPaisDepartamento == 0) { Mensaje = "Debe ingresar un valor en Codigo Pais Departamento."; _Resultado = false; goto salir; }
                ...
                switch (_TipoDeOperacion)
                {
                    ...
                    case ModuloGeneral.TipoDeOperacion.Modificar:
                        if (Validar())
                        {
                            ...
                            _Data.AsignarCampo("CODIGO_PAIS_DEPARTAMENTO", _CodigoPaisDepartamento);
