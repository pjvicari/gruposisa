...
namespace Negocio
{
    public class Corporacion : Base
    {
        ...
        private int _IdPaisCorporacion = 0; public int IdPaisCorporacion { get => _IdPaisCorporacion; set => _IdPaisCorporacion = value; }
        private int _IdDepartamentoCorporacion = 0; public int IdDepartamentoCorporacion { get => _IdDepartamentoCorporacion; set => _IdDepartamentoCorporacion = value; }
        private int _IdMunicipioCorporacion = 0; public int IdMunicipioCorporacion { get => _IdMunicipioCorporacion; set => _IdMunicipioCorporacion = value; }
        ...
        private bool Validar()
        {
            ...
            try
            {
                ...
                if (_IdPaisCorporacion == 0) { Mensaje = "Debe ingresar un valor en Id Pais Corporacion."; _Resultado = false; goto salir; }
                if (_IdDepartamentoCorporacion == 0) { Mensaje = "Debe ingresar un valor en Id Departamento Corporacion."; _Resultado = false; goto salir; }
                if (_IdMunicipioCorporacion == 0) { Mensaje = "Debe ingresar un valor en Id Municipio Corporacion."; _Resultado = false; goto salir; }
                ...
                switch(_TipoDeOperacion)
                {
                    ...
                    case ModuloGeneral.TipoDeOperacion.Modificar:
                        if(Validar())
                        {
                            ...
                            _Data.AsignarCampo("ID_PAIS_CORPORACION", _IdPaisCorporacion);
                            _Data.AsignarCampo("ID_DEPARTAMENTO_CORPORACION", _IdDepartamentoCorporacion);
                            _Data.AsignarCampo("ID_MUNICIPIO_CORPORACION", _IdMunicipioCorporacion);
                    ...
                    case ModuloGeneral.TipoDeOperacion.Eliminar:
                        if (_CodigoCorporacion == 0) { Mensaje = "Debe ingresar un valor en Codigo Corporacion."; _Resultado = false; goto salir; }
                        _Data.AsignarCampo("CODIGO_CORPORACION", _CodigoCorporacion, true);
                        _Data.AsignarCampo("FECHA_BAJA", "now()");
                        _Data.AsignarCampo("ESTADO_CORPORACION", _EstadoCorporacion);
